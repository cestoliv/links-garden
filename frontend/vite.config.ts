...
// dev server's origin is blocked. Proxying /api server-to-server sidesteps CORS entirely instead
// of asking the Python side to add headers, and keeps the dashboard and the API same-origin so
